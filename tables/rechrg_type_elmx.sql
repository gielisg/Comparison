drop table if exists "informix".rechrg_type_elmx ;
create table "informix".rechrg_type_elmx 
  (
    rechrg_type_id integer not null ,
    element_id integer not null ,
    oth_rechrg_tp_id integer not null ,
    oth_element_id integer not null ,
    ...
    check (isolation_level IN ('C' ,'I' ,'P' ,'X' )) constraint "informix".cipx2,
