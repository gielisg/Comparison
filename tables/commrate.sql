drop table if exists "informix".commrate ;
create table "informix".commrate 
  (
    commrateid serial not null ,
    ...
    check (commratecommtype IN ('ALL' ,'USAG' ,'CHRG' ,'PROF' ,'GRP' ,'PLAN' ,'CONN' )) 
              constraint "informix".commrate147,
    
    check (commrateratetype IN ('PERC' ,'FIXD' ,'GRP' )) constraint "informix".commrate240,
