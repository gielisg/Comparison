drop table if exists "informix".optb_occ_map ;
create table "informix".optb_occ_map 
  (
    trans_desc varchar(150,15) not null ,
    credit_ind char(1) 
        default 'N' not null ,
    chg_code char(4),
    auto_exclude char(1) 
    ...
    check (credit_ind IN ('Y' ,'N' )) constraint "informix".yes_no
