drop table if exists "informix".tnz_chg_tar_map ;
create table "informix".tnz_chg_tar_map 
  (
    tnz_chg_tp_ref serial not null ,
    billing_desc varchar(250) not null ,
    spotcode char(5) not null ,
