drop table if exists "informix".st_mobvoc15 ;
create table "informix".st_mobvoc15 
  (
    ...
    vpg15_duration varchar(10),
    vpg15_exchg_rate varchar(6),
    vpg15_svc_chg_ind varchar(1),
    vpg15_filler varchar(74)
  );
